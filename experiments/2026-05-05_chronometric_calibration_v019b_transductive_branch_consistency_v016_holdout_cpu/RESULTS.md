...
- run label: `chronometric_calibration_v019b_transductive_branch_consistency_v016_holdout_cpu`
- run kind: `transductive_branch_consistency_diagnostic`
- git commit: `1075b238a1176d6a37a168e87fbf85fdc491c5ca`
...
- eval scope: `group_holdout_by_source_condition_artifact_with_unlabeled_heldout_branch_consistency`
- device: `cpu`
- seed: `20260505`
- steps: `800`
...
- branch consistency pairs: `7`
- branch consistency uses heldout features: `True`
- training data promoted: `False`

## Metrics

- train baseline total loss: `5.138065814971924`
- train final total loss: `0.022146329283714294`
- train loss reduction vs baseline: `5.1159194856882095`
- train signed-Y MAE final: `0.005321831442415714`
- train progress accuracy final: `1.0`
- train positive best rank final: `1`
- train family MSE final: `0.08650817722082138`

## Heldout Metrics

- heldout baseline total loss: `0.24570952355861664`
- heldout final total loss: `0.007563053630292416`
- heldout loss reduction vs baseline: `0.23814646992832422`
- heldout signed-Y MAE final: `0.01702019013464451`
- heldout progress accuracy final: `1.0`
- heldout positive best rank final: `None`
- heldout positive mean rank final: `None`
- heldout family MSE final: `0.021345745772123337`
