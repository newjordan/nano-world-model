...
Status: posthoc bucket diagnostic for `chronometric_bucket_eval_v024_time_phase_translation_fallback`.

This is not a new training run and not ARC solve evidence. It checks which transition families carry the learned signal.

## Condition

- run label: `chronometric_bucket_eval_v024_time_phase_translation_fallback`
- run kind: `diagnostic_analysis_no_training`
- git commit: `be9d162d7cad15abf17752d7677bd5edab0a8765`
...
- calibration metrics: `experiments/2026-05-05_chronometric_branch_library_v024_time_phase_translation_fallback_v018_geometry_predictions/metrics.json`
- records: `7732`
...
- heldout records: `400` positives=`0` signed_MAE=`0.0018488270044326781` progress_acc=`1.0`
...
| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| movement:x_negative | 181 | 0 | 1 | 0.00387331 | 0.0014542 |
...
| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| time:pre_progress_step | 260 | 0 | 1 | 0.00220455 | 0.0014542 |
| time:post_progress_step | 130 | 0 | 1 | 0.00118522 | 0.000427192 |
