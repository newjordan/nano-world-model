...
Status: posthoc bucket diagnostic for `chronometric_bucket_eval_v025_stasis_loop_scope`.

This is not a new training run and not ARC solve evidence. It checks which transition families carry the learned signal.

## Condition

- run label: `chronometric_bucket_eval_v025_stasis_loop_scope`
- run kind: `diagnostic_analysis_no_training`
- git commit: `5e2b9aad9f126ca37a5c5c1031327c02f450bf48`
...
- calibration metrics: `experiments/2026-05-05_chronometric_branch_library_v025_stasis_loop_scope_v018_geometry_predictions/metrics.json`
- records: `7732`
...
- train records: `7332` positives=`52` signed_MAE=`5.528278774858757e-05` progress_acc=`1.0`
- heldout records: `400` positives=`0` signed_MAE=`9.615391492843628e-05` progress_acc=`1.0`
...
| control_label:dominant_group:stasis_loop | 76 | 0 | 1 | 0 | 0.0014542 |
| control_label:stasis_no_change | 65 | 0 | 1 | 0.000591716 | 6.12296e-05 |
| control_label:dominant_group:time_phase | 22 | 0 | 1 | 0 | 9.8398e-05 |

## Heldout Action Buckets

| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| action:ACTION6 | 103 | 0 | 1 | 0.000206761 | 0.0014542 |
| action:ACTION2 | 69 | 0 | 1 | 4.00206e-05 | 3.46886e-05 |
| action:ACTION4 | 61 | 0 | 1 | 3.35115e-05 | 0.000104785 |
| action:ACTION3 | 58 | 0 | 1 | 5.9431e-05 | 5.42714e-05 |
| action:ACTION5 | 58 | 0 | 1 | 1.37533e-05 | 0.000325672 |
| action:ACTION1 | 51 | 0 | 1 | 0.000159115 | 7.50393e-05 |

## Heldout Movement Buckets

| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| movement:x_negative | 181 | 0 | 1 | 0 | 0.0014542 |
| movement:none | 75 | 0 | 1 | 0.000512821 | 6.12296e-05 |
| movement:y_positive | 67 | 0 | 1 | 0 | 0.000526582 |
| movement:x_positive | 49 | 0 | 1 | 0 | 9.8398e-05 |
...
| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| time:pre_progress_step | 260 | 0 | 1 | 0.00010219 | 0.0014542 |
| time:post_progress_step | 130 | 0 | 1 | 8.65941e-05 | 0.000427192 |
| time:progress_step | 10 | 0 | 1 | 6.34909e-05 | 0.000218956 |
