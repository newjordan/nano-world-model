...
Status: posthoc bucket diagnostic for `chronometric_bucket_eval_v022_time_phase_translation_branch_library`.

This is not a new training run and not ARC solve evidence. It checks which transition families carry the learned signal.

## Condition

- run label: `chronometric_bucket_eval_v022_time_phase_translation_branch_library`
- run kind: `diagnostic_analysis_no_training`
- git commit: `4bf6cf67acc4845b7e4ea3b2fb82f3b36508b9ec`
...
- calibration metrics: `experiments/2026-05-05_chronometric_branch_library_v022_time_phase_translation_v018_geometry_predictions/metrics.json`
- records: `7732`
...
- heldout records: `400` positives=`0` signed_MAE=`0.006403598150645848` progress_acc=`1.0`
...
| --- | ---: | ---: | ---: | ---: | ---: |
| control_label:dominant_group:translation | 237 | 0 | 1 | 0.0071873 | 0.000526582 |
...
| action:ACTION2 | 69 | 0 | 1 | 6.58565e-05 | 3.46886e-05 |
| action:ACTION4 | 61 | 0 | 1 | 0.00281778 | 0.000104785 |
| action:ACTION3 | 58 | 0 | 1 | 0.00258103 | 5.42714e-05 |
| action:ACTION5 | 58 | 0 | 1 | 0.0283069 | 0.000325672 |
| action:ACTION1 | 51 | 0 | 1 | 0.00313699 | 7.50393e-05 |

## Heldout Movement Buckets

| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| movement:x_negative | 181 | 0 | 1 | 0.00524984 | 0.0014542 |
| movement:none | 75 | 0 | 1 | 0.000800351 | 6.12296e-05 |
| movement:y_positive | 67 | 0 | 1 | 0.00765821 | 0.000526582 |
| movement:x_positive | 49 | 0 | 1 | 0.00109019 | 9.8398e-05 |
| movement:y_negative | 28 | 0 | 1 | 0.0351669 | 0.000186805 |

## Heldout Time Buckets

| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| time:pre_progress_step | 260 | 0 | 1 | 0.00791217 | 0.0014542 |
| time:post_progress_step | 130 | 0 | 1 | 0.00364824 | 0.000427192 |
| time:progress_step | 10 | 0 | 1 | 0.00300041 | 0.000218956 |
