...
Status: posthoc feature-coverage diagnostic for `chronometric_feature_coverage_v018_geometry_v015_support_v016_holdout_balance_cpu`.

This is not a new training run and not ARC solve evidence. It compares heldout feature buckets to train feature buckets.

## Condition

- run label: `chronometric_feature_coverage_v018_geometry_v015_support_v016_holdout_balance_cpu`
- run kind: `diagnostic_analysis_no_training`
- git commit: `8dd063c3d618870ab8589226f797980359efbe3c`
