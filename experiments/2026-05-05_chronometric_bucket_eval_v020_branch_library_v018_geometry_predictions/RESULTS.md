...
Status: posthoc bucket diagnostic for `chronometric_bucket_eval_v020_branch_library_v018_geometry_predictions`.

This is not a new training run and not ARC solve evidence. It checks which transition families carry the learned signal.

## Condition

- run label: `chronometric_bucket_eval_v020_branch_library_v018_geometry_predictions`
- run kind: `diagnostic_analysis_no_training`
- git commit: `cdd8c0569887db728f03a17b61764a238ddd6abd`
...
- calibration metrics: `experiments/2026-05-05_chronometric_branch_library_v020_v018_geometry_predictions/metrics.json`
- records: `7732`
...
- train records: `7332` positives=`52` signed_MAE=`0.006895978301113819` progress_acc=`1.0`
- heldout records: `400` positives=`0` signed_MAE=`0.018027649731448037` progress_acc=`1.0`
...
| control_label:dominant_group:time_phase | 22 | 0 | 1 | 0.0446189 | 9.8398e-05 |

## Heldout Action Buckets

| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| action:ACTION6 | 103 | 0 | 1 | 0.0206562 | 0.0014542 |
...
| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| movement:x_negative | 181 | 0 | 1 | 0.013132 | 0.0014542 |
...
| bucket | rows | positives | progress acc | signed MAE | top false-positive prob |
| --- | ---: | ---: | ---: | ---: | ---: |
| time:pre_progress_step | 260 | 0 | 1 | 0.0183175 | 0.0014542 |
