...
Status: posthoc bucket diagnostic for `chronometric_bucket_eval_v008c_gated_temporal_context_cpu`.

This is not a new training run and not ARC solve evidence. It checks which transition families carry the learned signal.

## Condition

- run label: `chronometric_bucket_eval_v008c_gated_temporal_context_cpu`
- run kind: `diagnostic_analysis_no_training`
- git commit: `c5b4cd43294f75e6938d26f78e05003a34b90519`
- git dirty at run: `False`
- manifest: `experiments/2026-05-05_arc_bridge_manifest_v006_cross_family/arc_bridge_manifest.jsonl`
- predictions: `experiments/2026-05-05_chronometric_calibration_v008c_gated_temporal_context_cpu/predictions.jsonl`
- calibration metrics: `experiments/2026-05-05_chronometric_calibration_v008c_gated_temporal_context_cpu/metrics.json`
- records: `2744`
