...
├── dream_kernel_v001.md  (known-map internal imagination micro-simulator)
...
- **[Dream Kernel V001](dream_kernel_v001.md)** — known-map internal imagination kernel for deterministic state/action/ray rollout sequences.
